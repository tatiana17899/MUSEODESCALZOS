...
namespace MUSEODESCALZOS.Data.Migrations
{
    ...
    [Migration("20240929234359_USUARIO")]
           ...
           modelBuilder.Entity("MuseoDescalzos.Models.Usuario", b =>
            {
                ...
                b.HasOne("MuseoDescalzos.Models.Cliente", "Cliente")
                    .WithMany() // Si quieres que Cliente tenga una colección de Usuarios, reemplaza WithMany() con WithMany("Usuarios")
                    .HasForeignKey("ClienteId") // Asegúrate de que la propiedad ClienteId exista en la clase Usuario
                    .OnDelete(DeleteBehavior.Cascade); 

                // Relación con Calificación_Noticia
                b.HasOne("MuseoDescalzos.Models.Calificación_Noticia", "Calificación_Noticia")
                    .WithMany() // Si deseas que Calificación_Noticia tenga una colección de Usuarios, cambia esto
                    .HasForeignKey("CalificaciónNoticiaId") // Asegúrate de que la propiedad CalificaciónNoticiaId exista en la clase Usuario
                    .OnDelete(DeleteBehavior.Cascade); 
